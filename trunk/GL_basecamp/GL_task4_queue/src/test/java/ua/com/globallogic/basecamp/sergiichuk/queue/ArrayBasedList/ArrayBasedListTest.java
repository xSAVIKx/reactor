...
public class ArrayBasedListTest {
    private ArrayBasedList<String> stringList;
    private ArrayBasedList<Integer> intList;
	...
	stringList = new ArrayBasedList<>();
	intList = new ArrayBasedList<>();
    }
	...
	assertEquals(10 * 2, stringList.size());
	assertEquals(10 * 2, intList.size());
	...
	assertEquals(null, stringList.remove(0));
	assertEquals(null, intList.remove(0));
	assertEquals(0, stringList.size());
	assertEquals(0, intList.size());
    }
